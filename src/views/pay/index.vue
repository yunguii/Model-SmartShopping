<template>
  <div class="pay">
    ...
    <div class="pay-list">
      <div class="list">
        <div class="goods-item" v-for="item in orderList.goodsList" :key="item.goods_id">
          <div class="left">
      ...
      <div class="flow-num-box">
        ...
        <span class="money">￥{{ orderList.orderTotalPrice }}</span>
      </div>
...
export default {
  ...
  computed: {
    ...
    logAddress () {
      return this.addressList[0].region.province + this.addressList[0].region.city + this.addressList[0].region.region + this.addressList[0].detail
    },
    cartIds () {
  ...
  methods: {
    ...
    async getOrderList () {
      if (this.$route.query.mode === 'cart') {
        const { data: { data } } = await getOrder(
          this.$route.query.mode, { cartIds: this.cartIds }
        )
    ...
    async submitOrder () {
      if (this.$route.query.mode === 'cart') {
        await postOrder(this.$route.query.mode, {
